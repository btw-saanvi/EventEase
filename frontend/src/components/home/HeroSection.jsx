  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden bg-oatly-bg pt-20 pb-10 border-b-[4px] border-black">
      ...
      <div className="section-container relative z-10 max-w-5xl mx-auto text-center">
        {/* Headline */}
        <h1 className="font-heading text-6xl md:text-8xl text-black leading-[1.1] mb-8 uppercase drop-shadow-[4px_4px_0px_#FFB0C2]">
          Wow, another event planning site.
          <br />
        ...
        <p className="text-xl md:text-3xl text-black font-body font-bold max-w-3xl mx-auto mb-12 bg-white border-[3px] border-black shadow-[4px_4px_0px_#000] p-4 -rotate-1 inline-block">
          Where every celebration finds its perfect place. (Or so our marketing department says.)
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 font-heading uppercase text-lg">
          <span className="text-black bg-white border-[2px] border-black px-4 py-1 shadow-[2px_2px_0px_#000] -rotate-2">Popular:</span>
          <Link to="/vendors?category=makeup" className="text-black hover:text-oatly-pink hover:underline underline-offset-4 decoration-4">Makeup Artist</Link>
          <Link to="/vendors?category=photographer" className="text-black hover:text-oatly-blue hover:underline underline-offset-4 decoration-4">Photographer</Link>
          <Link to="/packages?type=wedding" className="text-black hover:text-oatly-green hover:underline underline-offset-4 decoration-4">Wedding Packages</Link>
        </div>
      </div>
    </section>
  );
